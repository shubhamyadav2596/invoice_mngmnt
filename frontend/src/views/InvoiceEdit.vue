                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                      ...
                      <input 
                        ...
                        maxlength="6"
                        :class="{ 'is-invalid': errors.customerPincode }"
                      >
...
export default {
  ...
  methods: {
    ...
    validatePincode() {
      ...
      // Validate pincode
      if (this.invoice.invoiceToDetails.pincode && !/^\d{6}$/.test(this.invoice.invoiceToDetails.pincode)) {
        this.errors.customerPincode = 'Pincode must be exactly 6 digits';
      } else {
        this.errors.customerPincode = '';
      }
    },
    async updateInvoice() {
      try {
        // Validate pincode
        if (!/^\d{6}$/.test(this.invoice.invoiceToDetails.pincode)) {
          this.errors.customerPincode = 'Pincode must be exactly 6 digits';
          return;
        }
