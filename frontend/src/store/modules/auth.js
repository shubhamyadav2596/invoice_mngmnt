...
const actions = {
  async login({ commit }, credentials) {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VUE_APP_API_URL}/api/auth/login`, credentials)
  ...
  async register({ commit }, userData) {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VUE_APP_API_URL}/api/auth/register`, userData)
      const { token, user } = response.data
  ...
  async checkAuth({ commit, dispatch }) {
    ...
    try {
      ...
      // Fetch user data
      const response = await axios.get(`${import.meta.env.VUE_APP_API_URL}/api/auth/me`)
